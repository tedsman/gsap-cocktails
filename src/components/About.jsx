    ...
    <div id='about'>
        ...
        <div className="top-grid">
          ...
          <div className="md:col-span-3">
            <div className="noisy">
              <img src="/images/abt1.png" alt="picture" />
            </div>
          </div>

           <div className="md:col-span-6">
            <div className="noisy">
              <img src="/images/abt2.png" alt="picture" />
            </div>
          </div>

           <div className="md:col-span-3">
            <div className="noisy">
              <img src="/images/abt5.png" alt="picture" />
            </div>
          </div>
        ...
        <div className="bottom-grid">
           <div className="md:col-span-8">
            <div className="noisy">
              <img src="/images/abt3.png" alt="picture" />
            </div>
          </div>

           <div className="md:col-span-4">
            <div className="noisy">
              <img src="/images/abt4.png" alt="picture" />
            </div>
          </div>
        </div>
    </div>
